    ...
    <div className="my-3 rounded-xl border-2 border-amber-300 dark:border-amber-600 bg-amber-50 dark:bg-amber-900/20 overflow-hidden">
      ...
      <div className="px-4 py-3 space-y-3">
        <div>
          ...
          {request.description && (
            <div className="text-xs text-zinc-600 dark:text-zinc-400 mt-1">{request.description}</div>
          )}
        </div>
        ...
        {request.input != null && (
          <pre className="text-xs bg-white dark:bg-zinc-900 rounded-lg p-2 overflow-x-auto max-h-32 overflow-y-auto border border-amber-200 dark:border-amber-800">
            {String(typeof request.input === 'string'
              ? request.input
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className={cn('border-red-300 text-red-600 hover:bg-red-50 dark:border-red-700 dark:text-red-400 dark:hover:bg-red-900/20')}
          >
            <X size={14} />
            拒绝
          </Button>
